...
class HybridLinUCB():
	...
	def recommend(self, timestamp, user_features, articles):
		...
		# print(f'index:{index}')
		# print(f'article_features_tmp:{article_features_tmp}')
		...
		# print(f'AaIBaA0IBaTAaIxa:{AaIBaA0IBaTAaIxa}')
		...
		max_index = np.argmax(p) #通常は最大値
		# max_index = np.argmin(p) #最小値で試す
		...
		# print(f'articles[max_index]:{articles[max_index]}')
